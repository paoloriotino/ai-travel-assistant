...
1. Conversazione intelligente
    - Interazione via chat in linguaggio naturale
    - Comprensione del contesto e delle richieste utente
2. Raccolta requisiti
    - Estrazione e validazione dei dati utente (budget, destinazione, attività, periodo)
3. Generazione itinerario
...
- A scelta (Node.js, Django, Flask, Ruby on Rails)
Responsabilità:
...
### 3. Frontend
Tecnologie:
- A scelta (es HTML, CSS, JavaScript oppure framework React, Vue, Angular)
